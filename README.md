...
See the IPYNB for more extensive documentation (demo), essentially just for academic exercise to confirm that we can use MC simulations to estimate the Black Scholes closed-formed solution and to create some sort of basic UI.
